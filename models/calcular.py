...
class Calcular:
  def __init__(self:object, dificuldade: int)-> None:
    ...
    self.__operacao: int = randint(1, 3) #1=som, 2-diminui, 3-multiplica
  ...
  # para aparecer o nome das operação, ao invés de numeros gerados no randint
